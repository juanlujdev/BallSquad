...
@ApiParam(value = "Update an existent pet in the store", required = true )   @Valid @RequestBody Pet pet) {
...
,@ApiParam(value = "Name of pet that needs to be updated") @Valid @RequestParam(value = "name", required = false) String name

,@ApiParam(value = "Status of pet that needs to be updated") @Valid @RequestParam(value = "status", required = false) String status
...
,@ApiParam(value = "Additional Metadata") @Valid @RequestParam(value = "additionalMetadata", required = false) String additionalMetadata

,

@ApiParam(value = "" )   @Valid @RequestBody(required = false) MultipartFile body) {
