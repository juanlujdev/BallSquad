...
describe('StoreOrder Management Component', () => {
  let comp: StoreOrderComponent;
  let fixture: ComponentFixture<StoreOrderComponent>;
  let service: StoreOrderService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'store-order', component: StoreOrderComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(StoreOrderComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.storeOrders?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
